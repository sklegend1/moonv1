...
const Post_Brief = (props) => {

    const { content="<p>Empty</p>" , ...others} = props

    return (
        <div className=" relative aspect-[6/5] rounded-md bg-gray-900 bg-opacity-20 shadow-slate-400 m-5 shadow-inner p-[1%] w-3/4 mx-auto grid grid-cols-1 grid-rows-12 ">
            ...
            className=" overflow-hidden row-span-2 border-opacity-20 rounded-md  p-4 text-[1.5vw]"
            />
